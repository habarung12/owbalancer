...
const RANK_OPTIONS = [
  { label: 'Bronze 5', value: 500 }, { label: 'Bronze 4', value: 600 }, { label: 'Bronze 3', value: 700 }, { label: 'Bronze 2', value: 800 }, { label: 'Bronze 1', value: 900 },
  { label: 'Silver 5', value: 1000 }, { label: 'Silver 4', value: 1100 }, { label: 'Silver 3', value: 1200 }, { label: 'Silver 2', value: 1300 }, { label: 'Silver 1', value: 1400 },
  { label: 'Gold 5', value: 1500 }, { label: 'Gold 4', value: 1600 }, { label: 'Gold 3', value: 1700 }, { label: 'Gold 2', value: 1800 }, { label: 'Gold 1', value: 1900 },
  { label: 'Platinum 5', value: 2000 }, { label: 'Platinum 4', value: 2100 }, { label: 'Platinum 3', value: 2200 }, { label: 'Platinum 2', value: 2300 }, { label: 'Platinum 1', value: 2400 },
  { label: 'Emerald 5', value: 2500 }, { label: 'Emerald 4', value: 2600 }, { label: 'Emerald 3', value: 2700 }, { label: 'Emerald 2', value: 2800 }, { label: 'Emerald 1', value: 2900 },
  ...
  setup() {
    ...
    const checkBattleNet = async () => {
      ...
      try {
        ...
        const divBase: Record<string, number> = { bronze:500,silver:1000,gold:1500,platinum:2000,emerald:2500,diamond:3000,master:3500,grandmaster:4000,champion:4500 };
